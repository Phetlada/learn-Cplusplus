...
#include "head.h" #include <iostream>    // For NULL
...
// ListItr class; maintains "current position" // // CONSTRUCTION: Package friendly only, with a ListNode // // ******************PUBLIC OPERATIONS********************* // bool isPastEnd( )      ­­> True if past end position in list // void advance( )        ­­> Advance (if not already null)// Object retrieve        ­­> Return item in current position
...
//#include "LinkedList.cpp" // Remove // to Compiled #endif